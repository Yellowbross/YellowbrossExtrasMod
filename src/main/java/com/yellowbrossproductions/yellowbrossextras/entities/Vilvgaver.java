...
public class Vilvgaver extends YExtrasMob implements IEntityAdditionalSpawnData, Enemy {
    private static final EntityDataAccessor<Boolean> CHALLENGE = SynchedEntityData.defineId(Vilvgaver.class, EntityDataSerializers.BOOLEAN);
    int stuckTicks;
    int sayTicks;
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, Mob.class, 10, true, false, (p_29932_) -> {
            return p_29932_ instanceof Mob && !(p_29932_ instanceof Vilvgaver);
        }));
        super.registerGoals();
    }
