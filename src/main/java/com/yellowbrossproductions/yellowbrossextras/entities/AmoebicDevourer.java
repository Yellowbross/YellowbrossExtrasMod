...
public class AmoebicDevourer extends YExtrasMob implements Enemy {
    private static final EntityDataAccessor<Float> SIZE = SynchedEntityData.defineId(AmoebicDevourer.class, EntityDataSerializers.FLOAT);
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, Mob.class, 10, true, false, (p_29932_) -> {
            return p_29932_ instanceof Mob && !(p_29932_ instanceof AmoebicDevourer);
        }));
        super.registerGoals();
    }
