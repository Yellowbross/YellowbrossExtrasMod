...
public class DeadlyArrowEntity extends AbstractSnipingProjectile {
    SnipingProjectileHitResult hitResult = new SnipingProjectileHitResult();
    int i = 6;

    public DeadlyArrowEntity(EntityType<?> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.noPhysics = true;
    }

    public DeadlyArrowEntity(Level level, LivingEntity shooter, Vec3 shootTo) {
    ...
    public DeadlyArrowEntity(PlayMessages.SpawnEntity packet, Level level) {
