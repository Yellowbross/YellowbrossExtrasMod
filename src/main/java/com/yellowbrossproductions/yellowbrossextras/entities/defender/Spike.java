...
public class Spike extends Entity implements MobAttack {
    ...
    public Spike(EntityType<? extends Spike> p_36923_, Level p_36924_) {
        super(p_36923_, p_36924_);
    }

    public Spike(Level p_36926_, double p_36927_, double p_36928_, double p_36929_, float p_36930_, int p_36931_, LivingEntity p_36932_) {
