...
import com.yellowbrossproductions.yellowbrossextras.entities.defender.projectile.DefenderArrow;
...
public class Defender extends YExtrasMob implements YextrasEntity, IsDefenderAligned {
    ...
    private static final EntityDataAccessor<Integer> WEAPON_TO_SHOW = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> PHASE = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> PHASE_LIMIT = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> SHAKE_MULTIPLIER = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> KILLED_BY_VOID = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> SHOULD_HIDE_ALL_HATS = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> SHOULD_IMMEDIATELY_TURN = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> CHAINSAW_LOOK_X = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Integer> SECOND_HAT = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Float> STRETCH = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Integer> USING_CUSTOM_RENDER = SynchedEntityData.defineId(Defender.class, EntityDataSerializers.INT);
    ...
    class JumpAwayGoal extends CustomAttackGoal {
        ...
        public JumpAwayGoal(Defender defender) {
            super(defender);
        }
    ...
    class CustomMeleeAttackGoal extends MeleeAttackGoal {
        ...
        public CustomMeleeAttackGoal(Defender defender, double speed, boolean followEvenIfNotSeen) {
