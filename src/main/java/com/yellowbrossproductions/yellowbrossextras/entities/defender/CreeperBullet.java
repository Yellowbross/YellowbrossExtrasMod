...
public class CreeperBullet extends AbstractCreeperEntity implements IsDefenderAligned {
    private static final EntityDataAccessor<BlockPos> COLLISION_POS = SynchedEntityData.defineId(CreeperBullet.class, EntityDataSerializers.BLOCK_POS);
    private static final EntityDataAccessor<Float> SHOOT_Y = SynchedEntityData.defineId(CreeperBullet.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> SHOOT_X = SynchedEntityData.defineId(CreeperBullet.class, EntityDataSerializers.FLOAT);
    ...
    public CreeperBullet(EntityType<? extends YExtrasMob> p_21683_, Level p_21684_) {
    ...
    public boolean hurt(DamageSource source, float amount) {
        if (source.getEntity() instanceof CreeperBullet creeper) {
    ...
    public void spawnHittingSomething(Level world, Vec3 from, Vec3 to) {
        ...
        for (LivingEntity entity : entities) {
            ...
            if (!(entity instanceof CreeperBullet)) {
    ...
    class DontExplodeUntilGotUpGoal extends CreeperExplodeGoal {
        ...
        public boolean canUse() {
            return super.canUse() && !CreeperBullet.this.wasShotFromDefender;
        }
    }
    ...
    class DoNothingUntilGotUpGoal extends Goal {
        ...
        @Override
        public boolean canUse() {
            return CreeperBullet.this.wasShotFromDefender && CreeperBullet.this.getAnimationState().equals("getup") && CreeperBullet.this.getUpTicks <= 20;
        }
