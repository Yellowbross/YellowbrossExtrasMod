...
public class SniperRifle extends AbstractSnipingProjectile {

    public SniperRifle(EntityType<?> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.noPhysics = true;
    }

    public SniperRifle(Level level, LivingEntity shooter, Vec3 shootTo) {
    ...
    public SniperRifle(PlayMessages.SpawnEntity packet, Level level) {
