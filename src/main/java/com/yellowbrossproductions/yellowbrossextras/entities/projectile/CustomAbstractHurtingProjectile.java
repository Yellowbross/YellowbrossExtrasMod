...
// Clone of AbstractHurtingProjectile because for some reason. Trail particles are hardcoded. Into the original class. Frustrating, but what can I really do.
public class CustomAbstractHurtingProjectile extends Projectile {
    ...
    public boolean shouldDoParticles() {
        return this.shouldDoParticles;
    }

    public void setShouldDoParticles(boolean particles) {
        this.shouldDoParticles = particles;
    }
