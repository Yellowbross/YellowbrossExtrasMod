...
public class Sneaker extends AbstractCreeperEntity implements CreeperInfection, Enemy {
    private static final EntityDataAccessor<Integer> CREEPER_TYPE = SynchedEntityData.defineId(Sneaker.class, EntityDataSerializers.INT);
    private int explosionPull;

    public Sneaker(EntityType<? extends YExtrasMob> p_33002_, Level p_33003_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new MergeWithMyLoveGoal(this, Sneaker.class));
