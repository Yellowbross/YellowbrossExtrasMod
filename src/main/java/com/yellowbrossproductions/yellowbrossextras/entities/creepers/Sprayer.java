...
import com.yellowbrossproductions.yellowbrossextras.entities.projectile.TNTProjectile;
...
public class Sprayer extends AbstractCreeperEntity implements CreeperInfection, Enemy, RangedAttackMob {

    public Sprayer(EntityType<? extends YExtrasMob> p_33002_, Level p_33003_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new MergeWithMyLoveGoal(this, Sprayer.class));
