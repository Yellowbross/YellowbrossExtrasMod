...
import com.yellowbrossproductions.yellowbrossextras.entities.projectile.ConverslinBullet;
...
public class Converslin extends AbstractOryctolin {
    int frame;
    ...
    class OryctolinAvoidGoal extends AvoidEntityGoal {
        ...
        public void start() {
            super.start();
            if (!Converslin.this.AHHHHHH) {
                Converslin.this.setFace(FACE_CRY);
            }
        }
    ...
    class AttackGoal extends Goal {
        ...
        public boolean canUse() {
            return ((getTarget() != null && Converslin.this.distanceTo(getTarget()) < 30.0D && getTarget().isAlive() && Converslin.this.hasLineOfSight(getTarget()))) && !Converslin.this.AHHHHHH;
        }

        @Override
        public void start() {
            setFace(3);
            Converslin.this.canAttack = true;
        }
        ...
        @Override
        public void tick() {
            Converslin.this.getNavigation().stop();

            if (getTarget() != null) {
                getLookControl().setLookAt(getTarget(), 30.0F, 30.0F);
            }

            Converslin.this.navigation.stop();
        }

        @Override
        public void stop() {
            Converslin.this.canAttack = false;
        }
    }
    ...
    class Attack1Goal extends CustomAttackGoal {
        ...
        @Override
        public boolean canUse() {
            return random.nextInt(16) == 0 && getTarget() != null && !Converslin.this.AHHHHHH && Converslin.this.distanceTo(getTarget()) > 15.0D;
        }
        ...
        @Override
        public boolean canContinueToUse() {
            return attackTicks <= 30 && !Converslin.this.AHHHHHH;
        }
    ...
    class LiveLifeWithoutASingleCareGoal extends Goal {
        ...
        @Override
        public boolean canUse() {
            return Converslin.this.celebrating && !Converslin.this.AHHHHHH;
        }
