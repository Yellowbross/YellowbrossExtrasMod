...
@OnlyIn(Dist.CLIENT)
public class PathGuideRenderer extends EntityRenderer<PathGuideEntity> {
    ...
    public void render(PathGuideEntity p_116484_, float p_116485_, float p_116486_, PoseStack p_116487_, MultiBufferSource p_116488_, int p_116489_) {
        p_116487_.pushPose();
    ...
    @Override
    protected int getBlockLightLevel(PathGuideEntity p_114496_, BlockPos p_114497_) {
        return 15;
    }

    @Override
    public boolean shouldRender(PathGuideEntity p_114491_, Frustum p_114492_, double p_114493_, double p_114494_, double p_114495_) {
        return !p_114491_.isInvisible();
    }

    @Override
    public ResourceLocation getTextureLocation(PathGuideEntity p_114482_) {
