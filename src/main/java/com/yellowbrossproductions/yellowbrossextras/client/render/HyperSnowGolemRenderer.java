...
@OnlyIn(Dist.CLIENT)
public class HyperSnowGolemRenderer extends MobRenderer<HyperSnowGolemEntity, HyperSnowGolemModel<HyperSnowGolemEntity>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(HyperSnowGolemEntity p_110775_1_) {
        return TEXTURE;
    }
}
