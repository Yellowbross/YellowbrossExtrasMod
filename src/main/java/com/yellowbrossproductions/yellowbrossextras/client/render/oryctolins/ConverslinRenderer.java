...
@OnlyIn(Dist.CLIENT)
public class ConverslinRenderer extends MobRenderer<ConverslinEntity, ConverslinModel<ConverslinEntity>> {
    ...
    @Override
    public Vec3 getRenderOffset(ConverslinEntity p_114483_, float p_114484_) {
        return new Vec3(
    ...
    @Override
    protected void scale(ConverslinEntity p_115314_, PoseStack p_115315_, float p_115316_) {
        float f1 = 0.8F;
        p_115315_.scale(f1, f1, f1);
    }

    @Override
    public ResourceLocation getTextureLocation(ConverslinEntity p_110775_1_) {
