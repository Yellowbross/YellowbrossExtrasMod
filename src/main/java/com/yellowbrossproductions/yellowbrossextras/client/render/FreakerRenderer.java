...
@OnlyIn(Dist.CLIENT)
public class FreakerRenderer extends MobRenderer<FreakerEntity, FreakerModel<FreakerEntity>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(FreakerEntity p_110775_1_) {
        return TEXTURE;
    }
}
