...
import com.yellowbrossproductions.yellowbrossextras.entities.creepers.Sneaker;
...
@OnlyIn(Dist.CLIENT)
public class SneakerRenderer extends MobRenderer<Sneaker, SneakerModel<Sneaker>> {
    ...
    protected void scale(Sneaker creeper, PoseStack poseStack, float partialTick) {
