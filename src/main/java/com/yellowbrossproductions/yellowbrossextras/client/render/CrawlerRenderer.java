...
public class CrawlerRenderer extends MobRenderer<CrawlerEntity, CrawlerModel<CrawlerEntity>> {
    ...
    protected void scale(CrawlerEntity p_114046_, PoseStack p_114047_, float p_114048_) {
    ...
    protected float getWhiteOverlayProgress(CrawlerEntity p_114043_, float p_114044_) {
        float f = p_114043_.getSwelling(p_114044_);
        return (int)(f * 10.0F) % 2 == 0 ? 0.0F : Mth.clamp(f, 0.5F, 1.0F);
    }

    @Override
    public ResourceLocation getTextureLocation(CrawlerEntity p_110775_1_) {
        return TEXTURE;
    }
}
